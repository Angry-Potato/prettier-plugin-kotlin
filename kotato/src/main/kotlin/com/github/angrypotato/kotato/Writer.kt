...
open class Writer(
    ...
    fun StringBuilder.trimTrailingWhitespace() {
    ...
    protected fun trimTrailingWhitespace() = also { (app as StringBuilder).trimTrailingWhitespace() }
